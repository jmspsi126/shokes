	...
	<head>
      ...
      <div class="container-fluid">
        ...
        <main class="register">
          <div class="container">
            <div class="col-xs-12">
              <h3 class="col-sm-6 ">Develop your project the easy way</h3>
                ...
                <span>Please fill the form below</span>
                 <form class="form-horizontal" id = "form2" role="form" method="POST" action="{{ url('/auth/register') }}">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputSkillSet1" placeholder="Web Design, Web Development, SEO" name="skill">
