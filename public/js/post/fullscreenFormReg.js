...
( function( window ) {
	...
	function createElement( tag, opt ) {
		...
		console.log('createElement'+ ' tag '+ tag+' opt '+opt);
		if( opt ) {
			if( opt.cName ) {
	...
	FForm.prototype._init = function() {
		console.log("FForm.prototype._init");
		console.log(window.globalVar);
		// the form element
		this.formEl = this.el.querySelector( '#'+window.globalVar );
		console.log(this.el);
	...
	FForm.prototype._initEvents = function() {
		...
		document.addEventListener( 'keydown', function( ev ) {
			if( !self.isLastStep2 && ev.target.tagName.toLowerCase() !== 'textarea' ) {
	...
	FForm.prototype._nextField = function( backto ) {
		...
		this.isLastStep2 = this.current === this.fieldsCount -2 && backto === undefined ? true : false;


		this.msgError.innerHTML = "";
		this.submit = document.getElementById(window.globalVar+"submit");
		...
		var self = this,
			onEndAnimationFn = function( ev ) {
				...
				if(self.isLastStep2) {
					...
					classie.remove( self.submit, 'fs-submit');
					classie.add( self.submit, 'fs-show');
					// callback
