...
(function (factory) {
  ...
  var editingArea = renderer.create('<div class="note-editing-area p_sec1a"/>');
  var toolbar = renderer.create('<div class="note-toolbar panel-heading p_sec1b"/>');
  ...
  var buttonGroup = renderer.create('<span class="dropdown btn-group">');
  ...
  var Buttons = function (context) {
    ...
    this.addToolbarButtons = function () {
	  ...
	  context.memo('button.bold', function () {
         ...
         // contents: '<img src="/images/D3055639-B2C6-496B-BB52-41932B2D46F5@1x.png"><div class="clearfix"></div><span>BOLD</span>',
...
/*
      context.memo('button.bold', function () {
		  return '<a href="#"><img src="assets/images/D3055639-B2C6-496B-BB52-41932B2D46F5@1x.png"><div class="clearfix"></div><span>HEADING</span></a>';
        return ui.button({
          className: 'note-btn-bold',
          contents: ui.icon(options.icons.bold),
          tooltip: lang.font.bold + representShortcut('bold'),
...
*/
      ...
      context.memo('button.clear', function () {
        return ui.button({
          ...
          //contents: '<img src="/images/326DD670-BDDD-4FC9-ABBD-0258FF63972F@1x.png"><div class="clearfix"></div><span>PAGE BREAK</span>',
          ...
          children: [
            ...
            ui.dropdown({
              items: [
                ...
                '  <div>',
                '    <button type="button" class="note-color-reset  btn-default" data-event="backColor" data-value="inherit">',
                ...
                '  <div>',
                '    <button type="button" class="note-color-reset  btn-default" data-event="removeFormat" data-value="foreColor">',
